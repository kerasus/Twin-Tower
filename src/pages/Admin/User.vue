  ...
  data () {
    return {
      ...
      allProps: {
        config: {
          api: {
            show: API_ADDRESS.user.base,
            edit: API_ADDRESS.user.base,
            create: API_ADDRESS.user.base,
            index: API_ADDRESS.user.base
          },
          title: {
            show: 'اطلاعات کاربر',
            edit: 'اطلاعات کاربر',
      ...
      defaultInputs: [
        ...
        { type: 'optionGroupCheckbox', name: 'roles', responseKey: 'roles', multiple: true, value: [], optionValue: 'value', optionLabel: 'label', options: [{ label: 'بانی', value: 'bani' }, { label: 'مداح', value: 'madah' }, { label: 'سخنران', value: 'sokhanran' }, { label: 'مبلغ تایید نشده', value: 'unapproved_moballegh' }], col: 'col-md-3' },
